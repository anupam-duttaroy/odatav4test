					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test Data Post",
									"targetURL": "#posttestapp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"posttestapp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=posttestapp",
									"url": sap.ui.require.toUrl("posttestapp")
								}
							}
						}
					}
